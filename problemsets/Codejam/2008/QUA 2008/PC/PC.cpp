...
////////////////////////////////////////////////////////////////////////////////
// Área do segmento circular - apenas referente a corda, sem a parte triangular.
//          ***
//         *****
//        *  \/ *       (theta)
//         *   *
        ...
        for (double x1 = r+f; x1 < R-t-f; x1 += g+2*r)
            for (double y1 = r+f; y1 < R-t-f; y1 += g+2*r) {
                ...
                if (x2*x2 + y2*y2 <= rad*rad) {
                    ...
                    // Area do segmento circular mais metade do retângulo.
                    ...
                    // Area do segmento circular mais área quadrilatero (B*b)*h/2.
